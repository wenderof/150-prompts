...
import { Sparkles, MessageSquare, Infinity, Clock, Target, ShieldCheck, Play } from "lucide-react"
          ...
          <div className="relative glass p-2 md:p-3 rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden bg-[#0D0D12]">
             ...
             <div className="aspect-video w-full bg-black/40 rounded-[2rem] border border-white/5 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="z-10 flex flex-col items-center gap-4">
                  <div className="w-20 h-20 rounded-full bg-primary flex items-center justify-center glow-purple cursor-pointer hover:scale-110 transition-transform">
                    <Play className="w-8 h-8 text-white fill-white ml-1" />
                  </div>
                  <p className="text-xs font-bold tracking-[0.3em] uppercase text-white/60">Veja o Kit funcionando na prática</p>
                </div>
             </div>
          </div>
        </div>
